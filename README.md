...
```
empirical-ethics-of-the-computational/
│
├── profiles/        ← Individual member profiles
├── projects/        ← Shared research projects
└── resources/       ← Reading lists, references, and links
```
...
*This organization is maintained by the Empirical Ethics of the Computational research group at C³S.*
